const MOCK_GALLERY = [
  {
    media: {
      ...
      slang: ['RealWe', 'Trabalhe na Digix', 'Educação'],
  ...
  },
  {
    ...
    media: {
      ...
      slang: ['Habix', 'Tecnologia pública', 'Transformação digital', 'Noticias'],
  ...
  },
  {
    ...
    media: {
      ...
      slang: ['GPTW', 'Great Place To Work', 'Melhor Empresa', 'Noticias'],
