...
const MOCK_WINNING_SLOTS = [
  ...
  // ── movie · 9:16 ─────────────────────────────────────────────────────────
  {
    ...
    media: {
      ...
      thumbnail:
        'https://res.cloudinary.com/ddvgzvqsm/image/upload/v1767753628/1741383679533_gjteyc.jpg',
      description:
  ...
  // ── html · 9:16 ──────────────────────────────────────────────────────────
  {
    ...
    media: {
      ...
      resolution: null,
      guidance: 'portrait',
      html: '<div class="ws-tip"><span class="ws-tip__tag">Dica</span><h3>Conteúdo que ensina vence o algoritmo</h3><p>Vídeos com retenção alta entram organicamente em mais feeds.</p></div>',
      css: '.ws-tip{background:#0f172a;color:#fff;padding:20px;height:100%;display:flex;flex-direction:column;justify-content:flex-end;gap:8px}.ws-tip__tag{display:inline-block;align-self:flex-start;background:#fbbf24;color:#0f172a;font-weight:700;font-size:.7rem;padding:2px 10px;border-radius:999px;text-transform:uppercase;letter-spacing:.05em}.ws-tip h3{font-size:1.1rem;margin:0}.ws-tip p{font-size:.85rem;opacity:.8;margin:0}',
      description: 'Dica para criadores',
      id: 'ws-html-916-001-media',
      title: 'Dica para criadores',
      titleLink: 'dica-para-criadores',
    },
    channel: DIGIX_CHANNEL,
    comment: EMPTY_COMMENT,
  },
