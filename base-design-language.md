...
> `Heading`, `Link`, `Skeleton` e `Aspect ratio box` cobertos**. Todos os demais estão
> `⚠️ Divergente` (faltam stories e/ou verificação).
...
**Placar:** `✅ 10` · `⚠️ 55` (sendo `Icon` e `Tag` ⛔ bloqueados) · `🚫 (fora do escopo) 7`
