...
> **Icon (P1.2) ✅, Button (P1.6) ✅, Input (P1.7, 9/15 core), Stepper (P4.18) ✅, List (P1.10) ✅, Checkbox (P1.8) ✅ e Checkbox-v2 (P1.9) ✅ cobertos.**
> **Nenhum bloqueio (`⛔`) restante.** `Tag` livre (depende só de Icon). **P1 100% coberto** (Input
> 11/15 core; demais ✅); restam apenas P2 (Popover/Menu/Drawer, acoplados aos provedores), P3 e P4.
...
**Placar:** `✅ 41` · `⚠️ 22` (nenhum ⛔) · `🚫 (fora do escopo)`
