    ...
    groups: [
      {
        ...
        items: [
          ...
          { label: 'Button Dock', path: 'components/button-dock', status: 'soon' },
          ...
          { label: 'Segmented Control', path: 'components/segmented-control', status: 'soon' },
      ...
      },
      {
        label: 'Navigation',
        items: [
          { label: 'Bottom Navigation', path: 'components/bottom-navigation', status: 'soon' },
          ...
          { label: 'Page Control', path: 'components/page-control', status: 'soon' },
          ...
          { label: 'Tabs (Motion)', path: 'components/tabs-motion', status: 'soon' },
        ],
      },
      {
        label: 'Content',
        items: [
          ...
          { label: 'Badge - NotificationCircle', path: 'components/notification-circle', status: 'soon' },
          { label: 'Badge - HintDot', path: 'components/hint-dot', status: 'soon' },
          ...
          { label: 'Tag Group', path: 'components/tag-group', status: 'soon' },
          { label: 'Tile', path: 'components/tile', status: 'soon' },
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'System Banner', path: 'components/system-banner', status: 'soon' },
          { label: 'Empty State', path: 'components/empty-state', status: 'soon' },
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Dialog', path: 'components/dialog', status: 'soon' },
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'BaseProvider', path: 'components/base-provider', status: 'na' },
          ...
          { label: 'UseStyletron', path: 'components/use-styletron', status: 'na' },
          { label: 'Styled', path: 'components/styled', status: 'na' },
          { label: 'Tokens', path: 'components/tokens', status: 'soon' },
          { label: 'A11y Validator', path: 'components/unstable-a11y', status: 'na' },
        ],
      },
    ],
  },
