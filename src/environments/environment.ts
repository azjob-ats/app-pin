...
export const environment = {
  ...
  ROUTES: {
    ...
    EMPRESA: {
      ...
      PANEL: 'empresa/:slug',
      PANEL_PATH: 'empresa',
      PRODUCTS: 'empresa/:slug/produtos',
      PRODUCT_NEW: 'empresa/:slug/produtos/novo',
      PRODUCT_DETAIL: 'empresa/:slug/produtos/:productId',
      TRIAGE: 'empresa/:slug/triagens',
      TRIAGE_DETAIL: 'empresa/:slug/triagens/:submissionId',
      PEOPLE: 'empresa/:slug/pessoas',
      CREATORS: 'empresa/:slug/creators',
      PAGE: 'empresa/:slug/pagina',
      METRICS: 'empresa/:slug/metricas',
    },
    RESUME: {
